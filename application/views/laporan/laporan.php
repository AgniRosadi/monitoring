            ...
            <div class="col-sm-12" style="margin-bottom:10px;">
                <div class="card" style="border-color: blue;">
                    <div class="card-body form-group row">
                        ...
                        <a href="<?= base_url('laporan/excel'); ?>" class="btn btn-success" style="margin-left: auto;"><i class="fa fa-file-excel"></i> Export Excel</a>
                    </div>
                </div>
            </div>
        </div> <!-- Collapsable Card Example -->
                                ...
                                <div class="table-responsive">
                                    <table id="example1" class="table table-bordered table-striped ">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $query14 = $this->db->query("SELECT *, DATE_FORMAT(tanggal, '%d-%m-%Y') AS tanggal FROM data_parsial d join parsial p on d.id_parsial = p.id_parsial where d.id_master_kolam = $q->id_master_kolam and d.id_siklus = $qr->id_siklus order by d.id_parsial asc")->result();
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $qw->populasi ?> </td>
                                                    <td><?= $qw->parsial ?> </td>
                                                    <td align="right"><?= number_format($qw->pemasukan, 0, ',', '.') ?> </td>
