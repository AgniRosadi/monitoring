<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <?= form_error('form_air', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
            ...
            <div class="collapse show" id="collapseCardExample">
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>Suhu</label>
                            <input type="number" min="1" class="form-control" id="suhu" name="suhu">
                            <?= form_error('suhu', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Salinitas</label>
                            <input type="number" min="1" class="form-control" id="salinitas" name="salinitas">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>Ph Pagi</label>
                            <input type="number" min="1" class="form-control" id="ph_pagi" name="ph_pagi">
                            <?= form_error('ph_pagi', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Ph Sore</label>
                            <input type="number" min="1" class="form-control" id="ph_sore" name="ph_sore">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" min="1" class="form-control" id="tg_air" name="tg_air">
